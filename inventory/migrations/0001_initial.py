    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_number', models.CharField(default=b'', max_length=255, blank=True)),
                ...
                ('sort_by_name', models.CharField(default=b'', max_length=255, blank=True)),
                ('shipment', models.CharField(default=b'', max_length=255, blank=True)),
